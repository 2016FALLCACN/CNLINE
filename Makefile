...
# USED VARIABLES
##################################################################################################################
javalibs = socket.io-client-0.6.2.jar:org.json.jar:Java-WebSocket-1.3.0.jar:engine.io-client-0.7.0.jar:okhttp-3.1.2.jar:okhttp-ws-3.1.2.jar:okio-1.11.0.jar
